...
// Rule checklist for one data source, shown in the "BRE Rules" popup on the
// Data Sources page. This enabled/disabled state is INDEPENDENT of the
// per-loan-product toggles in Settings › BRE Rule Setting.
// GET/PUT /data-source-rules/{sourceId}
export default function DataSourceRuleChecklist({ sourceId }) {
  ...
  const base = `/data-source-rules/${sourceId}`;
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  {r.description && (
                    <button
                      type="button"
                      aria-label={`What does the "${r.label}" check?`}
                      aria-expanded={info}
