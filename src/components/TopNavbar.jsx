...
export default function TopNavbar({ currentStep, setCurrentStep, selectedSourcesCount, onReset, user, onLogout }) {
  const steps = [
  ...
  return (
    <header className="bg-white/90 backdrop-blur-md border-b border-purple-100 sticky top-0 z-50 shadow-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3 cursor-pointer" onClick={() => setCurrentStep(1)}>
            ...
            <span className="font-extrabold text-sm text-[#3b0764] hidden md:inline">
              Data & Risk Platform
            </span>
          </div>

          {/* Top Navbar Steps (1, 2, 3) */}
          ...
          {/* Selection Counter & User Profile */}
          <div className="flex items-center space-x-3">
            <span className="text-xs text-purple-700 font-mono hidden sm:inline font-bold bg-purple-50 border border-purple-100 px-2.5 py-1 rounded-xl">
